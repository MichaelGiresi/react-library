...
export const App = () => {
  ...
  const restoreOriginalUrl = async (_oktaAuth: any, originalUri: any) => {
    history.replace(toRelevantUrl(originalUri || '/', window.location.origin));
  }
  return (
...
function toRelevantUrl(arg0: any, origin: string): import("history").LocationDescriptor<unknown> {
